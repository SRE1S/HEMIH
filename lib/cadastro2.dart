...
class cadastro_prestador extends StatefulWidget {
  const cadastro_prestador({Key? key}) : super(key: key);

  @override
  State<cadastro_prestador> createState() => _cadastro_prestador();
}

class _cadastro_prestador extends State<cadastro_prestador> {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: const Text(
            "Você está acessando como Prestador",
            style: TextStyle(
